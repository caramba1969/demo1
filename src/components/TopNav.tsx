...
import { Menu, LogIn, LayoutDashboard, BarChart2, BookOpen, HeartHandshake, User } from "lucide-react";
...
export const TopNav: FC = () => (
  <nav className="w-full flex items-center justify-between px-4 py-2 bg-neutral-900 border-b border-neutral-800 shadow-sm z-50">
    ...
    <div className="flex gap-2 items-center">
      <Button variant="ghost" className="flex gap-1 text-neutral-200" aria-label="Planner">
