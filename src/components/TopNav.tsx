...
export const TopNav: FC = () => {
  ...
  return (
    <nav className="w-full flex items-center justify-between px-4 py-2 bg-neutral-900 border-b border-neutral-800 shadow-sm z-50">
      ...
      {/* App nav — only shown when logged in */}
      {isLoggedIn && (
        <div className="flex gap-2 items-center">
          <Link href="/">
            <Button
              variant="ghost"
              className={`flex gap-1 ${pathname === '/' ? 'text-orange-400 bg-orange-500/10' : 'text-neutral-200 hover:text-orange-300 hover:bg-orange-500/10'}`}
              aria-label="Planner"
            >
          ...
          <Link href="/graph">
            <Button
              variant="ghost"
              className={`flex gap-1 ${pathname === '/graph' ? 'text-orange-400 bg-orange-500/10' : 'text-neutral-200 hover:text-orange-300 hover:bg-orange-500/10'}`}
              aria-label="Graph"
            >
          ...
          <Link href="/flow">
            <Button
              variant="ghost"
              className={`flex gap-1 ${pathname === '/flow' ? 'text-orange-400 bg-orange-500/10' : 'text-neutral-200 hover:text-orange-300 hover:bg-orange-500/10'}`}
              aria-label="Flow Editor"
            >
              <Workflow className="w-5 h-5" /> Flow
            </Button>
          </Link>
          <Link href="/locations">
            <Button
              variant="ghost"
              className={`flex gap-1 ${pathname === '/locations' ? 'text-orange-400 bg-orange-500/10' : 'text-neutral-200 hover:text-orange-300 hover:bg-orange-500/10'}`}
          ...
          <Link href="/recipes">
            <Button
              variant="ghost"
              className={`flex gap-1 ${pathname === '/recipes' ? 'text-orange-400 bg-orange-500/10' : 'text-neutral-200 hover:text-orange-300 hover:bg-orange-500/10'}`}
              aria-label="Recipes"
            >
          ...
          {session.user.role === 'admin' && (
            <>
              <Link href="/changelog">
                <Button
                  variant="ghost"
                  className={`flex gap-1 ${pathname === '/changelog' ? 'text-orange-400 bg-orange-500/10' : 'text-neutral-200 hover:text-orange-300 hover:bg-orange-500/10'}`}
              ...
              <Link href="/admin">
                <Button
                  variant="ghost"
                  className={`flex gap-1 ${pathname === '/admin' ? 'text-orange-400 bg-orange-500/10' : 'text-orange-400 hover:text-orange-300 hover:bg-orange-500/10'}`}
                  aria-label="Admin"
                >
